...
import { setResource } from '../../redux/actions/resourcesActions';

// This hook is used to fetch all top-level institutions and put them in Redux, to avoid fetching same data many times
export const useFetchResource = <T extends Journal | Publisher>(id: string, errorMessage: string): [T, boolean] => {
