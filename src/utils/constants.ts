...
const { REACT_APP_AUTHORITY_REGISTER_API_URL, REACT_APP_PUBLICATION_CHANNEL_API_URL } = process.env;

export const PUBLICATION_CHANNEL_API_URL = REACT_APP_PUBLICATION_CHANNEL_API_URL;
export const AUTHORITY_REGISTER_API_URL = REACT_APP_AUTHORITY_REGISTER_API_URL;
