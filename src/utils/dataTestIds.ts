export const dataTestId = {
  ...
  editor: {
    ...
    rightsRetentionsStrategy: 'rights-retentions-strategy',
    rightsRetentionsStrategyLink: 'rights-retentions-strategy-link',
    rightsRetentionsStrategyOverride: 'rights-retentions-strategy-override',
    rightsRetentionsStrategySaveButton: 'rights-retentions-strategy-save-button',
  ...
  myPage: {
    ...
    myProjectRegistrationsNotStartedCheckbox: 'my-project-registrations-not-started-checkbox',
    myProjectRegistrationsOngoingCheckbox: 'my-project-registrations-ongoing-checkbox',
