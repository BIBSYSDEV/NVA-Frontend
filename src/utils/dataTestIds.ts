export const dataTestId = {
  aggregations: {
    ...
    coordinatingFacetsSearchField: 'coordinating-facets-search-field',
    ...
    participantOrgFacetsSearchField: 'participant-org-facets-search-field',
    ...
    responsibleFacetsSearchField: 'responsible-facets-search-field',
  ...
  basicData: {
    ...
    centralImport: {
      ...
      checkboxNorwegian: 'show-norwegian-contributors-checkbox',
      checkboxTitle: 'duplicate-search-title-checkbox',
      checkboxUnverified: 'show-unverified-affiliations-checkbox',
  ...
  editor: {
    ...
    channelOwnerInfoButton: 'channel-owner-info-button',
    ...
    registerAccessInfoButton: 'register-access-info-button',
  ...
  registrationWizard: {
    contributors: {
      ...
      editAffiliationButton: 'edit-affiliation-button',
      replaceContributorButton: (index: number) => `replace-contributor-${index}`,
      replaceContributorAndAffiliationButton: (index: number) => `replace-contributor-and-affiliation-${index}`,
  ...
  tasksPage: {
    ...
    nvi: {
      ...
      showPublicationPointsButton: 'show-publication-points-button',
