...
export interface FetchResultsParams {
  ...
  [ResultParam.HasPublicFile]?: string | null;
...
export const fetchResults = async (params: FetchResultsParams, signal?: AbortSignal) => {
  ...
  if (params.hasPublicFile) {
    searchParams.set(ResultParam.HasPublicFile, params.hasPublicFile);
  }
  if (params.id) {
