...
const journalReference = Yup.object().shape({
  doi: Yup.string().url(),
...
const bookReference = Yup.object().shape({
  doi: Yup.string().url(),
...
const reportReference = Yup.object().shape({
  doi: Yup.string().url(),
...
const degreeReference = Yup.object().shape({
  doi: Yup.string().url(),
