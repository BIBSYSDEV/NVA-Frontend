...
export const getPublicationValidationSchema = (t: TFunction) =>
  Yup.object().shape({
    entityDescription: Yup.object().shape({
      mainTitle: Yup.string().required(t('feedback.required_field')),
      abstract: Yup.string(),
      ...
      contributors: Yup.array()
        .of(Yup.object()) // TODO
        .min(1, t('feedback.minimum_one_contributor')),
