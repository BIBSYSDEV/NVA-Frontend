          ...
          <PublicationChannelSearch
            ...
            errorMessage={
              error && touched.entityDescription?.reference?.publicationContext?.title ? (
                // Must use getIn of global touched variable instead of what is in meta of field, since meta.touched
                // always will evalute to true if it is a object (as in this case). Even though this field will update
