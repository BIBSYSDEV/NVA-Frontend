      ...
      <Autocomplete
        ...
        onChange={(_, inputValue, reason) => {
          if (reason === 'select-option') {
            ...
            setFieldValue(ResourceFieldNames.PubliactionContextId, inputValue.pop()?.id);
          } else if (reason === 'remove-option') {
            setFieldValue(ResourceFieldNames.PubliactionContextType, 'UnconfirmedJournal');
            setFieldValue(ResourceFieldNames.PubliactionContextId, '');
          }
          setQuery('');
        }}
        ...
        renderInput={(params) => (
          <AutocompleteTextField
            ...
            errorMessage={
              ...
              !!errors.entityDescription?.reference?.publicationContext?.id
                ? errors.entityDescription?.reference?.publicationContext?.id
                : ''
            }
          />
