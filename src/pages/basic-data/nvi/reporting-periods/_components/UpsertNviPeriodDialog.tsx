...
export const UpsertNviPeriodDialog = ({
  ...
  const shouldDisableYearOption = (date: Date) => {
    ...
    if (nviPeriod?.publishingYear === yearToCheck.toString()) return false; // Keep the period's own publishing year selectable - doesn't matter since field is disabled in edit mode
