...
export const NviCandidateListItem = ({ nviCandidate, candidateIndex }: NviCandidateListItemProps) => {
  ...
  const offsetCandidateState: CandidateOffsetState = {
    offsetCandidate: candidateIndex,
  };
