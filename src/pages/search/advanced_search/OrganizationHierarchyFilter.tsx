...
interface OrganizationHierarchyFilterProps {
  organization: Organization;
}

export const OrganizationHierarchyFilter = ({ organization }: OrganizationHierarchyFilterProps) => {
    ...
    <>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} variant="outlined" label={t('search.search_for_sub_unit')} />}
        />
