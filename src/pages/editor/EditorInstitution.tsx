  ...
  return (
    <>
      ...
      {isLoadingCustomer || isLoadingInstitution ? (
        ...
        <>
          <Typography variant="overline">{t('editor.institution.institution_name_norwegian')}</Typography>
          <Typography paragraph>{institution?.name.nb ?? '-'}</Typography>

          <Typography variant="overline">{t('editor.institution.institution_name_english')}</Typography>
          <Typography paragraph>{institution?.name.en ?? '-'}</Typography>

          <Typography variant="overline">{t('editor.institution.institution_short_name')}</Typography>
